      ...
      <div className="container">
        <div className="back d-flex .align-items-center m-auto pt-3">
          ...
          <div className={`${style.acc_details}`}>
            <Image src={"/sidebaricons/country1.png"} height={50} width={50}/>
          ...
          <div className='icon_container d-flex justify-content-center py-5'>
            ...
            <div className={`${style.icon_wrapper}`}>
              <div className={`${style.icon_box}`}>
                <Image src={"/sidebaricons/bill 1.png"} width={18} height={18}/>
              </div>
              <p>Pay a Bill</p>
            </div>
            <div className={`${style.icon_wrapper}`}>
        ...
        <div className='d-flex align-items-center justify-content-between'>
          <p>USD Activity</p>
          <span><Image src={"/sidebaricons/icon.png"} width={10} height={10}/></span>
        </div>
        <Table />
      </div>
    </div>
