  ...
  return (
    <div>
      <div className='text-center py-1'>
        <Image src={"/sidebaricons/country2.png"} className='rounded-3' width={85} height={50}/>
      </div>
      <div className={`${style.fundcard} col my-3`} onClick={handleSidebarOpen}>
        <div className="d-flex justify-content-between">
          <div className='d-flex align-items-center'>
            <Image src={"/fundingoptions/verified.png"} width={15} height={15}/>
            <span className={`${style.heading}`}>Interac Transfer</span>
          </div>
          <div>
            <Image src={"/fundingoptions/>icon.png"} width={10} height={10}/>
          </div>
        </div>
        ...
        <Image src={"/fundingoptions/Interac.png"} width={20} height={20}/>
      </div>
      ...
      <div className={`${style.fundcard} col my-3`}>
        ...
        <Image src={"/fundingoptions/master.png"} width={27} height={18} className='me-2'/>
        <Image src={"/fundingoptions/visa.png"} width={41} height={13} className='me-2'/>
        <Image src={"/fundingoptions/stripe.png"} width={40} height={17} className='me-2'/>
      </div>
      ...
      <div className={`${style.fundcard} col my-3`}>
        ...
        <Image src={"/images/expedier_logo.svg"} width={80} height={27}/>
      </div>
